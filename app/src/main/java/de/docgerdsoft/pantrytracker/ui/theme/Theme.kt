...
// verbatim to the brand handoff's role->hex table; surface-tint tonal variants
// not enumerated there (surfaceContainerLow/High/Highest, surfaceBright/Dim,
// scrim, surfaceTint) are left to M3 to derive. The AddGreen/RemoveRed verb
