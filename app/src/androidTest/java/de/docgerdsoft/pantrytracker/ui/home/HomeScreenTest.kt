...
class HomeScreenTest {
    ...
    private class FakeRepository(
        ...
        // The delete + UNDO + restore round-trip is covered by HomeSnackbarEventTest
        // (instrumented), which uses its own stateful fake.
        override suspend fun restore(product: Product): Unit =
            throw NotImplementedError(
                "test harness does not exercise restore — " +
                    "see HomeSnackbarEventTest, or HomeViewModelTest.FakeProductRepository",
            )
    }
}
